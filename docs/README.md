...
<h1 align="center">mtr cityrail france</h1>
...
Si vous téléchargez à partir des Releases, sélectionnez le programme d'installation de votre système.
 ...
 Plateforme | Fichier |
| -------- | ---- |
| Windows x64 | `MTR-CityRail-France-win-x64.exe ` |
| macOS | `MTR-CityRail-France-mac-universal.dmg` |
| Linux x64 | `MTR-CityRail-France-linux-x86_64.AppImage` |
